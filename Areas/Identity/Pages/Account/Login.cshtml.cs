    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //Gọi phương thức đăng nhập là _signInManager.SignInAsync();
                ...
                {
                    ModelState.AddModelError(string.Empty, "Tài khoản không tồn tại hoặc sai tên tài khoản hay mật khẩu.");
                    return Page();
                }
            }
